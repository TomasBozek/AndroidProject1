...
- [x] E1T1 Three small things the review found · 3 → 3
...
- [x] E2H2 A network security config and StrictMode for the debug build · 6 → 3
- [x] E2P2 The dependency graph is submitted · 3 → 3
...
- [x] E3S5 Inventory: filter sheet, sort, and a selection toolbar · 25 → 12 · after E3S1
- [x] E3S6 Home opens Inventory, and a flow drives the whole loop · 12 → 6 · after E3S4, E3S5
- [x] E3T1 Unused components earn their place (was F6, C0T1) · 12 → 3 · decides D65 · after E3S6
