...
| Holds | What it is |
|---|---|
| `MainActivity` | the single activity, edge to edge, with the splash screen. Remembers the back stack unconditionally on the first frame and gates the display instead |
